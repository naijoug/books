...
| 样本包 | `samples/ai-agent-sample-pack.md`、`samples/ai-agent-dirty-workspace-one-pager.md` | dirty workspace 心跳接力主线：10 张精选卡片建立最小闭环，附录和配套一页纸模板补足验证证据、未验证项交接、下一条安全命令、最终报告字段和错误边界 review 输入；适合复制给周期性唤醒的 Agent 使用 |
