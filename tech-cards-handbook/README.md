...
| AI Agent | `chapters/ai-agent/` | 50 张：Agent 边界、工具、工具结果、记忆、上下文预算、上下文状态设计、反馈判断、反馈修订、反馈池、迭代上限、心跳工作流、工作日志资产化、启动快照、规划取舍、人类假设、静默成功反向测试、交接、接力取舍、无人值守默认动作、外部发布授权、启动前 staged 归属、提交范围台账、短节拍边界、交付预算、验证总结、未验证项交接、提交状态读回、dirty workspace 归属判断、dirty workspace 收尾清单、最终报告边界、失败输出吸收、固定范围 AI 编程审查 offer、证据请求边界、首份报告交付、30 分钟路线验证、发布反馈证据形状、AI 生成 PR 审查入口、AI 辅助 PR 审查产品阶梯、先复用已有技能、下一条安全命令梯、匿名案例证据边界、公开案例事实/推断/未验证分层、repo 入口里的 Agent 规则、本地 proof checker、全量 proof 基线、统一 preflight wrapper、proof 输出可移植、启动层边界和助手操作系统；dirty workspace 心跳接力的推荐阅读路径见 `chapters/ai-agent/README.md` |
