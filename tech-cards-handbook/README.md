...
| AI Agent | `chapters/ai-agent/` | 66 张，按四条主线维护：运行控制（边界、工具、记忆、上下文、反馈、心跳、规划、交接、无人值守默认动作和 dirty workspace 接力）；验证与证据（静默成功反向测试、失败吸收、green baseline、安全债、本地 proof checker、全量 proof 基线、统一 preflight wrapper、proof 输出可移植、证据字段 handoff、命令梯和未验证项交接）；所有权与交付（未提交/staged 归属、提交范围台账、大 dirty diff 接收回执、附录模板邻近同步、任务前清单与复盘沉淀分界、最终报告、稳定锚点、打包 staging、交付物 smoke test、生成物漂移检查、共享 package 断言、外部发布授权和无真实链接验证）；产品化阶梯（AI 编程审查 offer、证据请求、首份报告、30 分钟路线、发布反馈、案例分层、AI 辅助 PR 审查路径、真实样例停止条件和公开案例事实分层）。dirty workspace 心跳接力的推荐阅读路径见 `chapters/ai-agent/README.md` |
