...
| AI Agent | `chapters/ai-agent/` | 59 张，按四条主线维护：运行控制（边界、工具、记忆、上下文、反馈、心跳、规划、交接、无人值守默认动作、dirty workspace 所有权和最终报告）；商业化与公开发布（AI 编程审查 offer、证据请求、首份报告、30 分钟路线、发布反馈、案例分层、外部发布授权和无真实链接验证）；proof 与交付工程化（静默成功反向测试、失败吸收、green baseline、安全债、本地 proof checker、全量 proof 基线、统一 preflight wrapper、proof 输出可移植、稳定锚点、打包 staging、交付物 smoke test 和生成物漂移检查）；助手操作系统（repo 规则入口、技能复用、模板入口两层选择、启动层边界和助手 OS 分层）。dirty workspace 心跳接力的推荐阅读路径见 `chapters/ai-agent/README.md` |
