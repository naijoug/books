...
| Swift | `chapters/swift/` | 11 张：值语义、async/await、基础值、字符串、集合、switch、可选绑定、闭包、defer 清理、Result 错误状态和显式重试策略 |
| Flutter | `chapters/flutter/` | 12 张：状态、列表、导航、测试、布局、输入控件、组件拆分、异步构建、生命周期检查、controller 释放、显式重试策略和领域定义的对外错误码 |
