...
本目录按"一张卡片一个 Markdown 文件"维护，共 86 张。文件名使用英文 `kebab-case`。
...
本章 86 张卡片帮助 AI 时代的程序员用 agent 工作流提升验证力，围绕四条主线展开：
