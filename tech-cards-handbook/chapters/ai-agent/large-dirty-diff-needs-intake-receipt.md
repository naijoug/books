...
- Sampled shape: mixed content edits + punctuation/formatting rewrite + reference-format repair
- Companion paths: README and appendix appear related to the same chapter handoff
- My ownership this turn: only reference-format repair is explainable
