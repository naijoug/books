...
> 选自《技术卡片随身宝典》AI Agent 系列（共 26 张）。本样本包优先覆盖“心跳型 Agent 在 dirty workspace 中如何安全接力”的最小链路。
...
这 5 张精选卡片选自《技术卡片随身宝典》AI Agent 系列的 26 张卡片。
