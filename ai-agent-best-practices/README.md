...
| 附录 A | 生产就绪检查清单 | Agent 上线前工具、权限、数据、评估、监控、止损和发布决策的一页式核对 |
| 附录 B | 生产就绪门禁填写样例 | 用客服工单 Agent 灰度场景演示 `warn` 结论、证据链、范围控制、后续整改，以及不能把 `block` 包装成 `warn` 的反例 |
| 附录 C | 上线评审会主持人脚本 | 把附录 A/B 转成 30～60 分钟评审会流程，帮助主持人收束证据、范围、结论和会后交接 |
